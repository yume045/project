<template>
  <div id="app">
    <nav class="navbar navbar-expand-lg navbar navbar-light" style="background-color: #00BFFF;">
  <a class="navbar-brand" href="/#/">Medical Service</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav">
      ...
      <a class="nav-link disabled " href="/#/Register">สมัครสมาชิก</a>
</nav>
    <router-view/>
  </div>
</template>
